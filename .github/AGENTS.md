...
**Optional:** If you have extra context (e.g., performance notes, breaking changes, important caveats), add an **Additional Notes** section **after** the standard template sections (Summary, Related, Changes, Test Plan):
